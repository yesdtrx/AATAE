...
class Encoder(nn.Module):
    ...
    def __init__(self, isize, nz, nc, ndf, ngpu, n_extra_layers=0, add_final_conv=True):
        ...
        while csize > 4:
            ...
            main.add_module('pyramid-{0}-BatchNorm2d'.format(out_feat),
...
class Decoder(nn.Module):
    ...
    def __init__(self, isize, nz, nc, ngf, ngpu, n_extra_layers=0):
        ...
        main.add_module('initial-{0}-BatchNorm2d'.format(cngf),
                        nn.BatchNorm2d(cngf))
        ...
        while csize < isize // 2:
            ...
            main.add_module('pyramid-{0}-BatchNorm2d'.format(cngf // 2),
        ...
        for t in range(n_extra_layers):
            ...
            main.add_module('extra-layers-{0}-{1}-BatchNorm2d'.format(t, cngf),
                            nn.BatchNorm2d(cngf))
...
def define_G(opt, norm='batch', use_dropout=False, init_type='normal'):
    ...
    netG = ResnetGenerator(opt.nc, opt.nc, opt.ngf)
